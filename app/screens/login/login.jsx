...
import { LockSvgComponent, UserSvgComponent } from '../../components/icons'
import { useAuth } from '../../hooks/use-auth'
import { Loader } from '../../components/loader/loader'

const Login = () => {
  const { handleLogin, error, name, setName, password, setPassword, loading } =
    useAuth()
  return (
    <View className="relative bg-secondary flex-1">
      ...
      >
        <KeyboardAvoidingView
          className="mt-auto mb-0 px-3 pb-8"
          enabled
